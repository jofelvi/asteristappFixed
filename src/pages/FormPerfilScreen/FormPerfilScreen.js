...
class FormPerfilScreen extends Component {
  ...
  render() {
    const perfil = this.props.auth.perfil;
              ...
              <Formik
                ...
                {({
                  ...
                  <Fragment>
                    <Text>
                      {' '}
                      PERFIL DE USUARIO {this.props.auth.perfil.name}:{' '}
                    </Text>
                    <Text>
                      {' '}
                      Datos Personales: {this.props.auth.perfil.name}:{' '}
                    </Text>
                    <FormInput
                      label="USUARIO"
                      name="dni"
