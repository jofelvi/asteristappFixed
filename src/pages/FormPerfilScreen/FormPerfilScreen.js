...
import {traerUsuario, traerPerfil, isload,editarPerfil} from '../../store/auth/actions';
...
function FormPerfilScreen() {
  ...
  const handleSubmit = async (values) => {
   ...
   let data  =  {
    ...
    //console.log(JSON.stringify(auth.info.token));
  };
      ...
      <Formik
        ...
        {({
          ...
          <Fragment>
            ...
            <DatePicker
              defaultDate={
                //()=>moment(perfil.field_user_fechanac[0].value).format('DD-MM-YYYY')
                new Date(2018, 1, 1)
              }
            ...
            <Item picker>
              <Picker
                ...
                selectedValue={select2 === '' ? sexoInitial() : select2}
                onValueChange={(itemValue, itemIndex) => setSelect2(itemValue)}>
